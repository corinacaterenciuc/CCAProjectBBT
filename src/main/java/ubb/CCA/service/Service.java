package ubb.CCA.service;

import ubb.CCA.domain.*;
import ubb.CCA.repository.*;
...
//            int startline = temaXmlRepo.findOne(idTema).getStartline();
            //TODO: We checked if the "predate" is later than the deadline, bc only then the penalty is applied
            if(predata >= deadline) {
